function [trainedClassifier, validationAccuracy,trueLabels, predLabels] = AdaBoostTree(trainingData)
...
trueLabels = validationPredictions; 
predLabels = validationResponse; 
